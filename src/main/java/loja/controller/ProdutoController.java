...
public class ProdutoController {
	...
	public ResponseEntity<Produto> getById(@PathVariable Long Id) {//@PathVariable é o parâmetro concreto  "te entrego a garrafa p/ vc trazer cheia de água"
		return (ResponseEntity<Produto>) produtoRepository.findById(Id).map(resposta -> ResponseEntity.ok(resposta))// findById - método JPA |
