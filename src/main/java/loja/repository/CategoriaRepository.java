...
public interface CategoriaRepository extends JpaRepository<Categoria, Long>{
	...
	//JPA é um framework do spring p/ gravar(persistir) dados do banco. Uso herança p/ acessá-lo.
	...
	//findAllByIdContainingIgnoreCase - procure pelo o ID tudo o que contenha e ignore o case
